  ...
  return (
    <footer className='w-full mb-[100px] pb-10 md:mb-5' id='contact'>
        ...
        <div className='flex flex-col items-center'>
            ...
            <a href="mailto:successakinyemi365@gmail.com">
                <MagicButton 
        ...
        <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
            <p className='md:text-base text-sm md:font-normal font-light'>Copyright &copy; 2024 Success Akinyemi</p>
            ...
            <div className='flex items-center md:gap-3 gap-6'>
                {
                    socialMedia.map((item) => (
                        <div key={item?.id} className='w-10 h-10 cursor-pointer flex items-center justify-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black-300'>
                            <img src={item?.img} alt='social medias' width={20} height={20} />
                        </div>
                    ))
                }
            </div>
